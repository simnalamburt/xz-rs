        ...
        match coder.sequence {
            ...
            1 => {
                if *in_pos == in_size {
                    ...
                    if lzma_block_header_encode(&coder.block_options, &mut coder.buffer) != LZMA_OK
                    {
...
unsafe fn stream_encoder_end(coder: &mut lzma_stream_coder, allocator: *const lzma_allocator) {
